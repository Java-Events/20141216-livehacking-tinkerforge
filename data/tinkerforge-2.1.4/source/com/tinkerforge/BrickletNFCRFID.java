...
public class BrickletNFCRFID extends Device {
	 ...
	 * 
	 * * Call {@link BrickletNFCRFID#requestTagID(short)}
	 * * Wait for state to change to *RequestTagIDReady* (see {@link BrickletNFCRFID#getState()} or {@link BrickletNFCRFID.StateChangedListener})
	 * * Call {@link BrickletNFCRFID#getTagID()}
	 */
	 ...
	 * 
	 * * Call {@link BrickletNFCRFID#requestTagID(short)}
	 * * Wait for state to change to *RequestTagIDReady* (see {@link BrickletNFCRFID#getState()}
	 *   or {@link BrickletNFCRFID.StateChangedListener})
	 * * Call {@link BrickletNFCRFID#getTagID()} and check if tag ID is correct
	 * * Call {@link BrickletNFCRFID#authenticateMifareClassicPage(int, short, short[])} with page and key for the page
	 * * Wait for state to change to *AuthenticatingMifareClassicPageReady*
	 * * Call {@link BrickletNFCRFID#requestPage(int)} or :func`WritePage` to read/write page
	 */
	 ...
	 * * Wait for state to change to *RequestTagIDReady* (see {@link BrickletNFCRFID#getState()} or {@link BrickletNFCRFID.StateChangedListener})
	 * * Call {@link BrickletNFCRFID#getTagID()} and check if tag ID is correct
	 * * Call {@link BrickletNFCRFID#writePage(int, short[])} with page number and data
	 ...
	 * * Wait for state to change to *RequestTagIDReady* (see {@link BrickletNFCRFID#getState()} or {@link BrickletNFCRFID.StateChangedListener})
	 * * Call {@link BrickletNFCRFID#getTagID()} and check if tag ID is correct
	 * * Call {@link BrickletNFCRFID#requestPage(int)} with page number
	 * * Wait for state to change to *RequestPageReady*
	 * * Call {@link BrickletNFCRFID#getPage()} to retrieve the page from the buffer
	 * 
	 * If you use a Mifare Classic tag you have to authenticate a page before you
